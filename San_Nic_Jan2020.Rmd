...
# Key is the new name for the category, value is the new name for the response (in this case Abundance), … = c() is a list of all the species you want to aggregate, factor_key = true makes Species a factor.
...
Abalone_Survey_Data <- read.csv("AbFocusedWrackSurveySNIJan2020.csv")
...
Abalone_Survey_Data_long <- gather(data = Abalone_Survey_Data_reduced, 
                                 key = "Wrack.Use", value = "Abundance", factor_key = TRUE)
